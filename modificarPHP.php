...
?>
  ...
  <input type ="hidden" name="id" value="<?php echo $id; ?>">
    <?php echo '<p>Nombre completo *<input type="text" name="nombre" placeholder="Nombre completo del empleado" value ="'.$nombre.'"></p>'; ?>
     <!--<p>Nombre completo *<input type="text" name="nombre" placeholder="Nombre completo del empleado" value =""></p>-->
  </div>
      <div class="form-group">
      <?php echo '<p>Correo electrónico *<input type="text" name="email" placeholder="Correo electrónico" value ="'.$email.'"></p>'; ?>
      </div>
